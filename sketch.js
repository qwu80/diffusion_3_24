...
if (real_graph ==1){
      ...
      // }
      if (x_con>750) {
        if ((171.2-concentration*0.7)<(171.25-y_con)){
          ...
          triangle((10+100+70+change_square+940-change_length-70-760-20)*s_x, (171.2-concentration*0.7)*s_y, (170+x_con)*s_x, 171.25*s_y, (170+x_con)*s_x, (171.2-concentration*0.7)*s_y)
...
reset_scene1 = ()=> {
  ...
  console.log("sss")
   ...
   con_count =0
  //  if (sceneCount=0.55) {
  //   setTemperature_real(document.getElementById("slider_5").value)
  //   // console.log("kkk")
...
setTemperature_real = (te) => {
  ...
  document.getElementById("speed_1").value=(Math.pow(Math.pow(2.6,2)*Math.pow(10,14)*constant_temperature_real/300,1/2)).toExponential(1)
  document.getElementById("speed_2").value=Math.round(150*Math.pow((constant_temperature_real/300),-2.3)) //scarer

  document.getElementById("speed_3").value=(Math.pow(Math.pow(2.6,2)*Math.pow(10,14)*constant_temperature_real/300,1/2)).toExponential(1)
